...
public class BlockPos extends Vec3i {
    ...
    public net.minecraft.util.math.BlockPos toMcPos() {
        return new net.minecraft.util.math.BlockPos(getX(), getY(), getZ());
    }
    ...
    public BlockPos(net.minecraft.util.math.Vec3d vec) {
        this(vec.x, vec.y, vec.z);
    }
    ...
    public BlockPos(net.minecraft.util.math.Vec3i source) {
        this(source.getX(), source.getY(), source.getZ());
    }
