...
public class OldUtil {
    ...
    public static boolean isChest(Block parBlock) {
        if (BlockUtil.isAir(parBlock)) return false;
    ...
    public static BlockPos entToCoord(Entity ent) {
        return new BlockPos(MathHelper.floor(ent.posX), MathHelper.floor(ent.posY), MathHelper.floor(ent.posZ));
    }

    public static double getDistance(Entity ent, BlockPos coords) {
        return ent.getDistance(coords.getX(), coords.getY(), coords.getZ());
    }

    public static double getDistanceXZ(Entity ent, BlockPos coords) {
        return ent.getDistance(coords.getX(), ent.posY, coords.getZ());
    }

    public static double getDistanceXZ(BlockPos coords, BlockPos coords2) {
        return Math.sqrt(coords.distanceSq(coords2.getX(), coords.getY(), coords2.getZ()));
    }
